...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID = "1qmwrewk", // Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET = "production", // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN = "sk2rnX6zmVKUqS86TRSqMQNCZvUgM8kK2WPb3UWaHw47AbjIRNMS6OBvSdJHwOTn7ty1uhhL2uPCFesikKOuBSKMHCI2w2A5ALaxjwDr3XKz9Hoh4NfjEZJuaKV2aExu5sXlFn0CWB5RN6Ldkxrr6XBNf9fT3WcSYaT3wWGrkYxsOAP07r4C", // Sanity API token
...
const targetClient = createClient({
  projectId: NEXT_PUBLIC_SANITY_PROJECT_ID || "1qmwrewk",
  dataset: NEXT_PUBLIC_SANITY_DATASET || "production", 
  useCdn: false, // Disable CDN for real-time updates
  apiVersion: "2023-01-01", // Sanity API version
  token: NEXT_PUBLIC_SANITY_AUTH_TOKEN || "sk2rnX6zmVKUqS86TRSqMQNCZvUgM8kK2WPb3UWaHw47AbjIRNMS6OBvSdJHwOTn7ty1uhhL2uPCFesikKOuBSKMHCI2w2A5ALaxjwDr3XKz9Hoh4NfjEZJuaKV2aExu5sXlFn0CWB5RN6Ldkxrr6XBNf9fT3WcSYaT3wWGrkYxsOAP07r4C", 
});
